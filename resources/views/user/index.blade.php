                ...
                <form action="{{ route('user.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('nip_nik') is-invalid @enderror" name="nip_nik"
                                placeholder="nip_nik" value="{{ old('nip_nik') }}">
                            @error('nip_nik')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('no_telp') is-invalid @enderror" name="no_telp"
                                placeholder="Nomor Telpon" value="{{ old('no_telp') }}">
                            @error('no_telp')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
